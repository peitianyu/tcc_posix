...
/* midipix: POSIX 语义要求 long = 8 字节 (musl x86_64), 即使 PE 目标 */
#if PTR_SIZE == 8
# define LONG_SIZE 8
#else
# define LONG_SIZE 4
...
#define SYM_DEFER      0x04000000 /* defer-record marker on cleanup func sym */
...
ST_DATA const char *platform_arg; /* -platform=win|linux */
