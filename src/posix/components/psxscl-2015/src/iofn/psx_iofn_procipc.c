...
static int32_t __fastcall __psx_iofn_procipc_open_next(
...
static int32_t __stdcall __psx_iofn_procipc_open_parent_directory(
	void **		hparent,
	void *		hdir,
	uintptr_t *	buffer,
...
void __psx_iofn_procipc_init(struct __iovtbl * iovtbl)
{
	iovtbl->open_next	= __psx_iofn_procipc_open_next;
	...
	iovtbl->open_logical_parent	= __psx_iofn_procipc_open_parent_directory;
	iovtbl->open_physical_parent	= __psx_iofn_procipc_open_parent_directory;
}
