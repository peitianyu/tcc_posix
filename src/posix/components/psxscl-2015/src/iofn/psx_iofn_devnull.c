...
static int32_t __fastcall __psx_iofn_devnull_open_next(
...
int32_t	__stdcall __psx_iofn_devnull_read(
	void *			hfile,
	void *			hevent,
...
int32_t __stdcall __psx_iofn_devnull_write(
	void *			hfile,
	void *			hevent,
	nt_io_apc_routine *	apc_routine,
	void * 			apc_context,
...
static int32_t __stdcall __psx_iofn_devnull_open_parent_directory(
	void **		hparent,
	void *		hdir,
	uintptr_t *	buffer,
...
void __psx_iofn_devnull_init(struct __iovtbl * iovtbl)
{
	iovtbl->open_next	= __psx_iofn_devnull_open_next;
	...
	iovtbl->read		= __psx_iofn_devnull_read;
	iovtbl->write		= __psx_iofn_devnull_write;
	...
	iovtbl->open_logical_parent	= __psx_iofn_devnull_open_parent_directory;
	iovtbl->open_physical_parent	= __psx_iofn_devnull_open_parent_directory;
}
