...
struct pe_opt_hdr_32 {
	...
	unsigned char	size_of_inited_data	[0x04];		/* 0x08 */
	unsigned char	size_of_uninited_data	[0x04];		/* 0x0c */
	...
	unsigned char	data_dirs		[0x60];		/* 0x60 */
};
...
struct pe_opt_hdr_64 {
	...
	unsigned char	data_dirs		[0x70];		/* 0x70 */
};
...
struct pe_sec_hdr {
	uint8_t		name			[0x08];		/* 0x00 */
	uint32_t	virtual_size		;		/* 0x08 */
	uint32_t	virtual_addr		;		/* 0x0c */
	uint32_t	size_of_raw_data	;		/* 0x10 */
	uint32_t	pointer_to_raw_data	;		/* 0x14 */
	uint32_t	pointer_to_relocations	;		/* 0x18 */
	uint32_t	pointer_to_line_numbers	;		/* 0x1c */
	uint16_t	number_of_relocations	;		/* 0x20 */
	uint16_t	number_of_line_numbers	;		/* 0x22 */
